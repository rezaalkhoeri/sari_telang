...
class M_transaksi extends CI_Model
{
	...
	public function getPesananByOrder($no_order)
	{
		$this->db->select('tbl_rinci_transaksi.*, tbl_barang.*');
		$this->db->from('tbl_rinci_transaksi');
		$this->db->join('tbl_barang', 'tbl_rinci_transaksi.id_barang = tbl_barang.id_barang');
		$this->db->where('tbl_rinci_transaksi.no_order', $no_order);
		return $this->db->get()->result();
	}

	public function getTransaksiByOrder($no_order)
	{
		$this->db->from('tbl_transaksi');
