<!-- Navbar -->
<nav class="main-header navbar navbar-expand-md navbar-light navbar-white" style="background-color: #d7e995;">
	<div class="container">
		<a href="<?= base_url() ?>" class="navbar-brand">
			<img src="<?= base_url() ?>assets/gambar/logo.png" alt="" width="180">
		</a>
				...
				<li class="nav-item dropdown">
					...
					<ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
						<?php foreach ($kategori as $key => $value) { ?>
							<li><a href="<?= base_url('home/kategori/' . encrypt_url($value->id_kategori)) ?>" class="dropdown-item"> <?= $value->nama_kategori ?></a></li>
						<?php } ?>
			...
			<li class="nav-item">
				...
				<?php } else { ?>
					<a class="nav-link" data-toggle="dropdown" href="#">
						...
						<?php } else { ?>
							<img src="<?= base_url('assets/foto/default.jpg') ?>" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
						<?php } ?>
					</a>
