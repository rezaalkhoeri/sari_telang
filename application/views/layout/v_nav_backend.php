...
<aside class="main-sidebar sidebar-light-success elevation-4" style="background-color: #d7e995;">
	<!-- Brand Logo -->
	<a href="<?= base_url('admin') ?>" class="brand-link" align="center">
		...
		<span class="brand-text font-weight-bold">Halaman Admin</span>
	</a>
	...
	<div class="sidebar">
		...
		<div class="user-panel mt-3 pb-3 mb-3 d-flex">
			<div class="image">
				<img src="<?= base_url() ?>assets/gambar/logo4.png" class="img-circle elevation-2" alt="User Image">
			</div>
			<div class="info">
